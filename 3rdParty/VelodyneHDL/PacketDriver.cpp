...
__declspec(dllexport) PacketDriver::PacketDriver()
{

}

__declspec(dllexport) PacketDriver::PacketDriver(unsigned int port) : _port(port)
{
...
__declspec(dllexport) void PacketDriver::InitPacketDriver(unsigned int port)
{
  _port = port;
...
__declspec(dllexport) bool PacketDriver::GetPacket(std::string* data, unsigned int* data_length)
{
  try {
...
__declspec(dllexport) void PacketDriver::GetPacketCallback(const boost::system::error_code& error, std::size_t num_bytes, std::string* data, unsigned int* data_length)
{
